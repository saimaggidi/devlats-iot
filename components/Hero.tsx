      ...
      <div className="container mx-auto px-6 relative z-10">
        <div className="flex flex-col lg:flex-row items-center gap-12 lg:gap-20">
            ...
            <div className="lg:w-1/2 space-y-8 text-center lg:text-left animate-slide-up">
                 ...
                 <h1 className="text-5xl max-[400px]:text-[2.3rem] lg:text-[3.5rem] font-display font-bold text-white leading-[1.1] tracking-tight lg:min-h-[2.2em]">
                    {text1}
                 ...
                 {clientLogos.map((logo, i) => (
                     <div key={i} className="bg-white p-4 rounded-xl shadow-sm flex items-center justify-center w-full h-[90px]">
                        <img 
                            src={logo.url} 
                            alt={logo.name} 
                            className={`${logo.h} w-auto object-contain max-w-full max-h-full`} 
                        />
                     </div>
                 ))}
            </div>
